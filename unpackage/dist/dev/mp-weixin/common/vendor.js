...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"doItMusic","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var store = new _vuex.default.Store({
  ...
  getters: {
    /**
              * 播放页背景图片
              */
    audioPageBg: function audioPageBg(state) {var
      picUrl = state.picUrl,defaultPicUrl = state.defaultPicUrl;
  ...
  mutations: {
    ...
    setAudioId: function setAudioId(state, val) {
      state.audioId = val;
    },
    setAudioTitle: function setAudioTitle(state, val) {
      console.log('setAudioTitle--', val);
      state.audioTitle = val;
    },
    setPicUrl: function setPicUrl(state, val) {
      console.log('setPicUrl--', val);
      state.picUrl = val;
    },
    setAudioLrc: function setAudioLrc(state, val) {
      state.audioLrc = val;
    },
    setAudioMeta: function setAudioMeta(state, val) {
      state.audioMeta = val;
    } },
...
/* 45 */
/*!*******************************************************!*\
  !*** F:/HBuilderX/pro/doItMuisic/utils/audioUtils.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 媒体工具类

/**
 * 根据lrc歌词字符串解析成对象
 * @param {Object} lrc
 */
var createLrcObj = function createLrcObj(lrc) {
  var oLRC = {
    ti: "", //歌曲名
    ar: "", //演唱者
    al: "", //专辑名
  ...
  for (var i in lrcs) {//遍历歌词数组
    ...
    if (isNaN(parseInt(s[0]))) {//不是数值
      ...
      for (var _k in arr) {
        var _t = arr[_k].substring(1, arr[_k].length - 1); //取[]间的内容
        var _s = _t.split(":"); //分离:前后文字
        oLRC.ms.push({ //对象{t:时间,c:歌词}加入ms数组
          t: (parseFloat(_s[0]) * 60 + parseFloat(_s[1])).toFixed(3),
          c: content });
...
{
  createLrcObj: createLrcObj };exports.default = _default;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _index = _interopRequireDefault(__webpack_require__(/*! ../conf/index.js */ 47));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
apiList.forEach(function (item) {
  api[item.name] = function (params) {var _ref =

    params || {},data = _ref.data,header = _ref.header,dataType = _ref.dataType;
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var config = {
  ...
  yunApiBaseUrl: 'http://127.0.0.1:8080/' };var _default =
...
/* 48 */
/*!*********************************************************!*\
  !*** F:/HBuilderX/pro/doItMuisic/static/css/styles.css ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
